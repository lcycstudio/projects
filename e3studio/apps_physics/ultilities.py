...
def apps_physics_image_path_front(instance, filename):
    return 'e3studio/images/apps/Physics Apps/{0}/{1}'.format(instance.appname, filename)


def apps_physics_image_path_top(instance, filename):
    return 'e3studio/images/apps/Physics Apps/{0}/{1}'.format(instance.appname, filename)


def apps_physics_image_path_right(instance, filename):
    return 'e3studio/images/apps/Physics Apps/{0}/{1}'.format(instance.appname, filename)
