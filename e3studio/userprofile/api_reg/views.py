...
class UserLoginView(GenericAPIView):
    ...
    def get_mc(self):
        ...
        try:
            clu = ClientUser.objects.get(user_id=self.user)
        ...
        # getMnger, u_created = ClientUser.objects.get_or_create(
        #     user_id=self.user,
        #     defaults={
...
class UserEmailConfirmView(TemplateResponseMixin, View):
    ...
    template_name = os.path.join(
        e3studio_settings.BASE_DIR, "templates/client/email_confirm_client.html")
...
class UserEmailCompleteView(TemplateResponseMixin, View):
    # allauth_settings.TEMPLATE_EXTENSION
    template_name = os.path.join(
        e3studio_settings.BASE_DIR, "templates/account/email_complete_client.html")
