...
# from physics11.ultilities import chapter_image_path, section_image_path


def chapter_cover_path(instance, filename):
    return 'e3studio/images/quantum_mechanics/chapter/{0}/{1}'.format(instance.chapter, filename)


def section_image_path(instance, filename):
    return 'e3studio/images/quantum_mechanics/section/{0}/{1}/{2}'.format(instance.chapter, instance.section, filename)
...
class Chapter(models.Model):
    ...
    cover = models.ImageField(
        upload_to=chapter_cover_path, verbose_name="chapter image", blank=True, null=True)
