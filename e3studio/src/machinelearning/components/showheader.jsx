...
const ShowHeader = (props) => {
    ...
    }, [props.token, props.course, props.MainUrl, props.coursetitle, props.courseapi]);
    ...
    function handleUrl2(chapter, section, index) {
        // props.seturl(`courses/api/{coursetitle}/${chapter}/${index}`);
        ...
        <Header className="physics11-header text-center">
            {props.token ?
                loaded ?
                    ...
                    :
                    <h1>Welcome to {props.coursetitle}</h1>
                :
                <h1>Welcome to {props.coursetitle}</h1>
            }
        </Header>
