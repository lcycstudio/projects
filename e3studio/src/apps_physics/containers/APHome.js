...
import { appname, appapi } from '../components/appinfo';
...
const APHome = (props) => {
    ...
    function handleUrl2(appweb) {
        history.push(`/apps/physics/${appweb}`);
    };
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(APHome));
